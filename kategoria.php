<?php
include 'config.php';
$sql='select distinct(azonosito),nev,beosztas,kod,leírás from kategoriak,szemelyek,jelenlet where kategoriak.kod=jelenlet.kateg_kod && szemelyek.azonosito=jelenlet.sz_azon order by azonosito asc';
$stmt=$db->query($sql);
$str='';
            ...
            while($row=$stmt->fetch()){
                ...
                <tr class='table-row'>
                            ...
                            <td contenteditable='true'
                                ...
                                onClick='showEdit(this);'><?=$leírás?></td>     
                        </tr>
            <?php } ?> 
        </tbody>
    </table>
